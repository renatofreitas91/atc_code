# Documentação PT-PT do ATC

Esta pasta contém documentação em português europeu para apoiar a comunidade
lusófona. O inglês continua a ser o idioma de referência para a documentação
open-source e comunitária.
...
Os PDFs gerados estão disponíveis em [`../pdf`](../pdf/).
