# Documentacao PT-PT do ATC

Esta pasta contem documentacao em portugues europeu para apoiar a comunidade
lusofona. O ingles continua a ser o idioma de referencia para a documentacao
...
- [Documentacao Tecnica 2.1.7](ATC_2.1.7_DOCUMENTATION.md)

Os PDFs gerados estao disponiveis em [`../pdf`](../pdf/).
